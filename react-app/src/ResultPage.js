      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="form-container">
            ...
            <pre>remote1: {result.local_execution_time.toFixed(4)} seconds<br></br>
            remote2: {result.remote_execution_time_1.toFixed(4)} seconds<br></br>
            Total execution time: {result.total_execution_time.toFixed(4)} seconds<br></br>
            </pre>
